  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="food-modal bg-white rounded-[24px] p-6 w-full max-w-[600px] max-h-[90vh] overflow-y-auto mx-auto">
        <h2 className="text-2xl font-bold leading-[100%] mb-4 text-center" style={{color: '#FF9A0E'}}>Add a meal</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-center gap-3 pt-2">
            <button
              ...
              disabled={isLoading}
              className="food-add-submit-btn w-[150px] h-[45px] px-6 py-2 rounded-[14px] text-white font-bold text-sm leading-[100%] shadow-food-button disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
            ...
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="food-add-cancel-btn w-[150px] h-[45px] px-6 py-2 rounded-[14px] border border-[#FFBA26] bg-white text-black font-bold text-sm leading-[100%] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
          </div>
